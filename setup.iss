...
DirExistsWarning=no
OutputBaseFilename=JK_Infotech_ERP_Setup_v1.2.4
...
Source: "Y:\JK Infotech ERP\frontend\windows\AppPackages\JKErpWindows\JKErpWindows_1.2.4.0_x64_Test\*"; DestDir: "{app}\client"; Flags: recursesubdirs createallsubdirs ignoreversion
