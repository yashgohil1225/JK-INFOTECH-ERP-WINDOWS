...
OutputBaseFilename=JK_Infotech_ERP_Setup_v1.0.7
Compression=lzma
...
Source: "Y:\JK Infotech ERP\frontend\windows\AppPackages\JKErpWindows\JKErpWindows_1.0.7.0_x64_Test\*"; DestDir: "{app}\client"; Flags: recursesubdirs createallsubdirs ignoreversion
