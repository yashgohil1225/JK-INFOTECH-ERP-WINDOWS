...
DirExistsWarning=no
OutputBaseFilename=JK_Infotech_ERP_Setup_v1.1.9
...
Source: "Y:\JK Infotech ERP\frontend\windows\AppPackages\JKErpWindows\JKErpWindows_1.1.9.0_x64_Test\*"; DestDir: "{app}\client"; Flags: recursesubdirs createallsubdirs ignoreversion
