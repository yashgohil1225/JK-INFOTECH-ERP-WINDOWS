...
OutputBaseFilename=JK_Infotech_ERP_Setup_v1.0.8
Compression=lzma
...
Source: "Y:\JK Infotech ERP\frontend\windows\AppPackages\JKErpWindows\JKErpWindows_1.0.8.0_x64_Test\*"; DestDir: "{app}\client"; Flags: recursesubdirs createallsubdirs ignoreversion
